...
import type { Engine, Voice } from "react-native-tts";

import Android from "../../icons/ui/android.svg";
import IOS from "../../icons/ui/ios.svg";
...
export const EngineDropdown = ({ label }: { label: string }) => {
    ...
    const getEngineIcon = (engine: Engine) => {
